-- Place order with items: creates order, inserts order_items and computes totals
begin;
...
begin
  ...
  -- Note: column "total" is a generated column in order_items, do not insert into it.
