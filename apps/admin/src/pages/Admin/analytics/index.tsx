  ...
  return (
    <Section className="space-y-6 p-6">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <select className="w-[160px] rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:bg-white/10 dark:border-white/10" value={range} onChange={e=>setRange(e.target.value as any)}>
        ...
        {range === 'custom' && (
          <>
            <input type="date" className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:bg-white/10 dark:border-white/10" value={fromDate} onChange={e=>setFromDate(e.target.value)} />
            <input type="date" className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:bg-white/10 dark:border-white/10" value={toDate} onChange={e=>setToDate(e.target.value)} />
          </>
        )}
      </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-2">
                <button className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:border-white/10 dark:bg-white/10 dark:text-white" onClick={exportTopSlugsCSV}>Export CSV</button>
                <button className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:border-white/10 dark:bg-white/10 dark:text-white" onClick={exportTopSlugsJSON}>Export JSON</button>
              </div>
            </div>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-2">
                <button className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:border-white/10 dark:bg-white/10 dark:text-white" onClick={exportSourcesCSV}>Export CSV</button>
                <button className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:border-white/10 dark:bg-white/10 dark:text-white" onClick={exportSourcesJSON}>Export JSON</button>
              </div>
            </div>
            <div className="text-sm space-y-1">
              {topSources.map(([k,c])=> (
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <button className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:border-white/10 dark:bg-white/10 dark:text-white" onClick={downloadCsv}>Export CSV</button>
            </div>
            <div className="text-sm space-y-1">
              {utmReport.map(([k,c])=> (
                <div key={k} className="flex justify-between"><span>{k}</span><span>{c}</span></div>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-2">
                <button className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:border-white/10 dark:bg-white/10 dark:text-white" onClick={exportCTRCSV}>Export CSV</button>
                <button className="rounded-xl border border-border bg-white px-3 py-2 text-sm shadow-sm transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)] dark:border-white/10 dark:bg-white/10 dark:text-white" onClick={exportCTRJSON}>Export JSON</button>
              </div>
            </div>
            <div className="text-sm space-y-1">
              {ctrBySlug.map(r => (
