...
function AdminShell() {
  ...
  const items = [
    { to: "/", label: "Dashboard", index: true, icon: LayoutDashboard },
    { to: "/orders", label: "Orders" },
    { to: "/shop/products", label: "Products", icon: Box },
        ...
        >
          ...
          <Route index element={
            <Suspense fallback={<div className="p-6"><Skeleton className="h-6 w-32"/></div>}>
              {(() => { const Comp = lazy(() => import("@admin/pages/Admin/dashboard")); return <Comp/>; })()}
            </Suspense>
          } />
          ...
          <Route path="shop/products" element={
            <Suspense fallback={<div className="p-6"><Skeleton className="h-6 w-28"/></div>}>
              {(() => { const P = lazy(() => import("@admin/pages/Admin/shop/products/index")); return <P/>; })()}
            </Suspense>
          } />
          ...
          <Route path="orders" element={
            <Suspense fallback={<div className="p-6"><Skeleton className="h-6 w-28"/></div>}>
              {(() => { const P = lazy(() => import("@admin/pages/Admin/orders/index")); return <P/>; })()}
            </Suspense>
          } />
        </Route>

        {/* Redirect unknown to the root of the admin app */}
