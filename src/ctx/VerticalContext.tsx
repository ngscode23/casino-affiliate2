...
import casinoVertical from "@/verticals/casino";
import hostingVertical from "@/verticals/hosting";
...
function resolveVertical(): VerticalConfig {
  try {
    ...
    const v = (qs.get("vertical") || "casino").toLowerCase();
    return REGISTRY[v] || REGISTRY.casino;
  } catch {
    return REGISTRY.casino;
  }
}
...
const VerticalContext = React.createContext<VerticalConfig>(casinoVertical);
