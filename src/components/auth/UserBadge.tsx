...
export default function UserBadge() {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        onClick={() => signOut()}
        className="rounded-xl px-3 py-1.5 border border-border bg-white text-muted shadow-sm transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ui-accent-20)]"
      >
        Выйти
      </button>
    </div>
